  ...
  return (
    ...
    >
      <div className="md:w-1/2 text-center md:text-left">
        <h1 className="text-5xl md:text-7xl font-bold mb-2 text-nowrap">Ansul Khatana</h1>
        ...
        <p className="text-lg mb-5">
          I am a passionate business consultant specializing in growing profitable business with mordern technology.
        </p>
...
function Skills() {
  const skills = [
    ...
    { name: "Machine Learning", color: "bg-blue-300 dark:bg-blue-700" },
    { name: "React", color: "bg-cyan-200 dark:bg-cyan-800" },
    { name: "AI", color: "bg-gray-300 dark:bg-gray-700" },
    ...
    { name: "IOT", color: "bg-yellow-300 dark:bg-yellow-700" }
  ]
...
function Projects() {
  const projects = [
    {
      title: "IEMA Research and Development Pvt Ltd - Internship - 6 Months",
      description: "Developing and executing marketing strategies with cross-team collaboration communicating the value of IOT",
      link: "#"
    },
    {
      title: "NUS – National University Of Singapore - Internship - 4 Months",
      description: "Artificial Intelligence , Data Analytics & Business Development Of IOT Products",
      link: "/img/cert2.jpg"
    }
  ]
            ...
            <Card className="h-full transition-transform duration-300 hover:scale-105">
              <CardContent className="p-4 flex flex-col h-full">
                ...
                <Button asChild className="rounded-full bg-gradient-to-r from-green-400 to-blue-500 hover:from-green-500 hover:to-blue-600 text-white font-bold py-2 px-4 transition-all duration-300">
                  <a href={project.link} target="_blank" rel="noopener noreferrer">View Certificate</a>
                </Button>
              </CardContent>
            </Card>
          </motion.div>
...
function Education() {
  const educationDetails = [
    ...
    },
    {
      ...
      institution: "R.L.J.D.M.C.D.A.V PUBLIC SCHOOL, RANIGANJ(WB)",
      year: "2019 - 2020"
    }
  ]
    ...
    >
      ...
      <div className="flex justify-center space-x-4">
        <Button variant="outline" size="icon" asChild className="rounded-full">
          <a href="mailto:ansulkhatana12b@gmail.com" aria-label="Email">
        ...
        <Button variant="outline" size="icon" asChild className="rounded-full">
          <a href="https://linkedin.com/in/ansul-khatana" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
